...
class ParticipatedUserList extends StatefulWidget {
  final Opportunity opportunity;
  ParticipatedUserList(this.opportunity);
  @override
  _ParticipatedUserListState createState() => _ParticipatedUserListState();
}

class _ParticipatedUserListState extends State<ParticipatedUserList> {
  ...
  void initState() {
    super.initState();
    fetchParticipatedUsers(widget.opportunity.id);
  }
